...
<div class="mb-8">
    <div class="flex items-center">
        ...
        <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Edit Pengguna</h1>
    </div>
</div>
    ...
    <div class="p-6">
        <form action="{{ route('users.update', $user) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">
                        Password <span class="text-neutral-500">(Kosongkan jika tidak diubah)</span>
                    </label>
            ...
            <div class="mt-6 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-lg">
                <h3 class="text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Informasi Akun</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                        <span class="text-neutral-500 dark:text-neutral-400">ID Pengguna:</span>
                        <span class="ml-2 text-neutral-900 dark:text-neutral-100">{{ $user->id }}</span>
                    </div>
                    <div>
                        <span class="text-neutral-500 dark:text-neutral-400">Dibuat:</span>
                        <span class="ml-2 text-neutral-900 dark:text-neutral-100">{{ $user->created_at->format('d M Y H:i') }}</span>
                    </div>
                    <div>
                        <span class="text-neutral-500 dark:text-neutral-400">Terakhir diperbarui:</span>
                        <span class="ml-2 text-neutral-900 dark:text-neutral-100">{{ $user->updated_at->format('d M Y H:i') }}</span>
                    </div>
                </div>
            </div>
