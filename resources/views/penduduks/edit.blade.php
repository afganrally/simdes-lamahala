...
<div class="mb-8">
    <div class="flex items-center">
        ...
        <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Edit Data Penduduk</h1>
    </div>
</div>
        ...
        <form action="{{ route('penduduks.update', $penduduk) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nik" id="nik" value="{{ old('nik', $penduduk->nik) }}" required maxlength="16"
                ...
                <div>
                    ...
                    <input type="text" name="pekerjaan" id="pekerjaan" value="{{ old('pekerjaan', $penduduk->pekerjaan) }}" required
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3" required
                              class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">{{ old('alamat', $penduduk->alamat) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="dusun" id="dusun" value="{{ old('dusun', $penduduk->dusun) }}" required
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="rt" id="rt" value="{{ old('rt', $penduduk->rt) }}" required
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="rw" id="rw" value="{{ old('rw', $penduduk->rw) }}" required
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="no_kk" id="no_kk" value="{{ old('no_kk', $penduduk->no_kk) }}" required
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
                ...
                <div>
                    ...
                    <select name="status_tinggal" id="status_tinggal" required
                        ...
                        <option value="Tetap" {{ old('status_tinggal', $penduduk->status_tinggal) == 'Tetap' ? 'selected' : '' }}>Tetap</option>
                        <option value="Kontrak" {{ old('status_tinggal', $penduduk->status_tinggal) == 'Kontrak' ? 'selected' : '' }}>Kontrak</option>
                        <option value="Kost" {{ old('status_tinggal', $penduduk->status_tinggal) == 'Kost' ? 'selected' : '' }}>Kost</option>
                        <option value="Lainnya" {{ old('status_tinggal', $penduduk->status_tinggal) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_masuk" id="tanggal_masuk" value="{{ old('tanggal_masuk', $penduduk->tanggal_masuk ? $penduduk->tanggal_masuk->format('Y-m-d') : '') }}"
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_keluar" id="tanggal_keluar" value="{{ old('tanggal_keluar', $penduduk->tanggal_keluar ? $penduduk->tanggal_keluar->format('Y-m-d') : '') }}"
                           class="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-neutral-800 dark:text-neutral-100">
                </div>
            </div>
