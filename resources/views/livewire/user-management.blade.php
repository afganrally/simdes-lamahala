        ...
        <div class="p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="flex-1 max-w-md w-full">
                    <div class="relative">
                        <input type="text" wire:model.live.debounce.500ms="search" placeholder="Cari pengguna berdasarkan nama atau username..."
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                <thead class="bg-neutral-50 dark:bg-neutral-800">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Avatar</th>
                    ...
                    <tbody class="bg-white dark:bg-neutral-900 divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800"
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="text-sm text-neutral-500 dark:text-neutral-400">{{ $user->email ?? 'Tidak ada email' }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <button wire:click="edit({{ $user->id }})" class="text-warning-600 hover:text-warning-900 dark:text-warning-400 dark:hover:text-warning-300">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Tambahkan pengguna pertama untuk memulai.</p>
                                <div class="mt-6">
                ...
                <form wire:submit="{{ $isEdit ? 'update' : 'store' }}" class="p-6">
                    <div class="space-y-5">
                        ...
                        <div class="flex justify-center mb-6">
                            <div class="relative">
                                <div class="h-20 w-20 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center">
                                    @if($isEdit && $user)
                    ...
                    <div class="mt-8 flex gap-3">
                        ...
                        <button type="submit"
                            class="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-[1.02] flex items-center justify-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
