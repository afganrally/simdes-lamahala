        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-700">
            ...
            <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="flex-1 px-2 space-y-1">
                    ...
                    <a wire:navigate href="{{ route('access.index') }}" class="sidebar-item {{ request()->is('access*') ? 'bg-primary-500 text-white' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 hover:text-primary-500 dark:hover:text-primary-400' }}">
                        <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
